      ...
      <div class="w-full max-w-[440px] space-y-10">
        ...
        <form id="registerForm" class="space-y-6">
          <div class="space-y-5">
            <div class="space-y-2">
              ...
              <input class="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3.5 text-on-surface placeholder:text-on-surface-variant/40 focus:ring-2 focus:ring-primary-fixed transition-all duration-300" id="name" placeholder="Evelyn Thorne" type="text" />
            </div>
        ...
        <div class="flex flex-col items-center gap-6 pt-2">
          ...
          <div class="flex items-center gap-4 w-full">
            ...
            <span class="text-[10px] font-label font-bold text-on-surface-variant/40 uppercase tracking-[0.2em]">Or continue with</span>
            <div class="h-[1px] bg-outline-variant/30 flex-grow"></div>
          </div>

          <div class="flex gap-4 w-full">
            <button id="googleBtn" type="button" class="flex-1 flex items-center justify-center gap-2 py-3 rounded-full bg-surface-container-low border border-outline-variant/10 hover:bg-surface-container-highest transition-all group">
              ...
              <span class="text-xs font-bold text-on-surface-variant group-hover:text-on-surface transition-colors">Google</span>
            </button>

            <button id="appleBtn" type="button" class="flex-1 flex items-center justify-center gap-2 py-3 rounded-full bg-surface-container-low border border-outline-variant/10 hover:bg-surface-container-highest transition-all group">
              ...
              <span class="text-xs font-bold text-on-surface-variant group-hover:text-on-surface transition-colors">Apple</span>
            </button>
          </div>
        </div>
      </div>
